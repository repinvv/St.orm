...
namespace StormGenerator.Generation.Generators.MsSqlCiServices
{
    ...
    internal class CiHelper : NsFileGenerator
    {
        #region constructor
        GenOptions options;
        ...
        public override string Execute()
        {
            ...
            WriteLiteral(@"        {");
            WriteLiteral(Environment.NewLine);
            WriteLiteral(@"            using (var cmd = new SqlCommand(""sys.sp_sequence_get_range"", conn))");
            WriteLiteral(Environment.NewLine);
            WriteLiteral(@"            {                    ");
            WriteLiteral(Environment.NewLine);
            WriteLiteral(@"                cmd.CommandType = CommandType.StoredProcedure;");
            WriteLiteral(Environment.NewLine);
            WriteLiteral(@"                cmd.Transaction = trans;");
            WriteLiteral(Environment.NewLine);
            WriteLiteral(@"                cmd.Parameters.AddWithValue(""");
            WriteLiteral(@"@");
            WriteLiteral(@"sequence_name"", sequenceName);");
            WriteLiteral(Environment.NewLine);
            WriteLiteral(@"                cmd.Parameters.AddWithValue(""");
            WriteLiteral(@"@");
            WriteLiteral(@"range_size"", count);");
            WriteLiteral(Environment.NewLine);
            ...
            WriteLiteral(Environment.NewLine);
            WriteLiteral(@"                cmd.Parameters.Add(firstValue);");
            WriteLiteral(Environment.NewLine);
